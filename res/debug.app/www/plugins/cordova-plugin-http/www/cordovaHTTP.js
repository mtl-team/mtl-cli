...
var http = {
    ...
    post: function(url, params, headers, success, failure) {
        ...
        return exec(success, failure, "CordovaHttpPlugin", "post", [url, params, headers, settings]);
    },
    get: function(url, params, headers, success, failure) {
        headers = mergeHeaders(this.headers, headers);
        settings = this.settings;
        return exec(success, failure, "CordovaHttpPlugin", "get", [url, params, headers, settings]);
    },
